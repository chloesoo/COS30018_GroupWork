                ...
                if (Agreemsg != null) {
                	String locationToDeliver = "";
 			    	if(Agreemsg.getSender().getName().startsWith("da1") && routesA.size() != 0) {
                        ...
                        send(informLocation);
                        //System.out.println("delivery location: " + routesA.get(0));
                        //k=k+1;
     			    }
                        ...
                        informLocation.addReceiver(Agreemsg.getSender());  
                        send(informLocation);
                        //System.out.println("delivery location: " + routesB.get(0));
                        //k=k+1;
     			    }
                        ...
                        informLocation.addReceiver(Agreemsg.getSender());  
                        send(informLocation);
                        //System.out.println("delivery location: " + routesC.get(0));
                        //k=k+1;
    			    }
                        ...
                        informLocation.addReceiver(Agreemsg.getSender());  
                        send(informLocation);
                        //System.out.println("delivery location: " + routesD.get(0));
                        //k=k+1;
     			    }	
     			    else {
